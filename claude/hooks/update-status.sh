...
end = datetime.fromisoformat(b.get('endTime', '').replace('Z', '+00:00'))
...
remain_str = f'{hours}h{minutes:02d}m'

dir_seg = f'#[fg=colour245,bg=colour236] {dir_name} ' if dir_name else ''

print(f'#[fg=colour255,bg=colour54] \u26a1{model} #[fg=colour255,bg=colour25] \u25c6 {tokens_str} #[fg=colour255,bg=colour30] \$ {cost:.2f} #[fg=colour250,bg=colour238] \u23f1 {remain_str} {dir_seg}#[default]')
" 2>/dev/null)
